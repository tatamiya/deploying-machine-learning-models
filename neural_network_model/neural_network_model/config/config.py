# The Keras model loading does not play well with
# Pathlib at the moment, so we are using 
# the old os module style
...
PIPLINE_NAME = 'cnn_pipe'
CLASSES_NAME = 'classes'
ENCODER_NAME = 'encoder'

# MODEL FITTING
IMAGE_SIZE = 150  # 50 for testing
BATCH_SIZE = 10
